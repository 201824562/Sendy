...
class LocationRVAdapter(receivedlocationdata: List<LocationItemData>, var itemClick: (LocationItemData) -> Unit): RecyclerView.Adapter<LocationRVAdapter.SearchViewHolder>()  {
            ...
            binding.root ) //==parent view
    {
        ...
        fun bind(data : LocationItemData){ //(커스텀) 하나씩 바인딩 해줌. -> 뷰 하나==아이템 '하나'
            ...
            itemView.setOnClickListener{
                itemClick(data)//1. 리턴값 : 클릭된 해당 하나짜리 뷰를 객체로 타입 변화하여 통째로 넘겨줌.
